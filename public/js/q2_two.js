  ...
  $("#signout").click(function() {
    ...
    $("#subButton").click(function() {
        ...
        if(checkId == 10){
          ...
          $("#subModal").find('.modal-content').fadeOut(1500);
          $('body').delay(1500).fadeOut(300, function() {
                  $(location).attr('href', '/q2_three')
                });
        ...
        var data = JSON.stringify({quizNum: 2, quizq: 2, res: checkId});
        $.ajax({
          type: "PUT",
          //url: "http://puppywebapi-env.8th8sduu2d.us-west-2.elasticbeanstalk.com/users",
